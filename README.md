...
const whoAmI = {
  name: "Luciana Pessoa",
  am: "self-taught",
  graduation: "Software Developer", nb nffhjfhmkfh
  job: "Fullstack Developer with PHP & ReactJS",
  currentCourse: "Rocketseat, JStack, Alura, LINUXtips, ProgramadorBR, Dio, Estudonauta.",cgmfhmfhbncmvbmvnmvnm
  hobbies: [
